...
function ControlODE(system::BioReactor)
    ...
    controller = Chain(
        ...
        Dense(3, 16, tanh_fast; initW=(x, y) -> Float32(5 / 3) * glorot_uniform(x, y)),
        Dense(16, 16, tanh_fast; initW=(x, y) -> Float32(5 / 3) * glorot_uniform(x, y)),
        Dense(16, 2; initW=(x, y) -> glorot_uniform(x, y)),
